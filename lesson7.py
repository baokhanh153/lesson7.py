...
Personality = {'Con mèo':'Lựa chọn này cho thấy bạn chưa sẵn sàng bắt dầu công việc, bạn khao khát được đi nghỉ.',
               'Con chó':'Bạn cảm nhận được sự hỗ trợ nhiệt tình của bạn bè và thế nên sẵn xàng giải quyết mọi quyết mọi vấn đề xảy ra.',
